...
const MASTER_RACE_DATES = {
  // 2025 Official Completed Dates (100% Verified)
  'las-vegas-2025': { date: '2025-02-01', end_date: '2025-02-02', status: 'completed' },
  'guadalajara-2025': { date: '2025-02-08', end_date: '2025-02-08', status: 'completed' },
  'bilbao-2025': { date: '2025-02-15', end_date: '2025-02-16', status: 'completed' },
  'glasgow-2025': { date: '2025-03-12', end_date: '2025-03-16', status: 'completed' },
  'malaga-2025': { date: '2025-03-21', end_date: '2025-03-23', status: 'completed' },
  'monterrey-2025': { date: '2025-04-05', end_date: '2025-04-05', status: 'completed' },
  'shanghai-2025': { date: '2025-04-05', end_date: '2025-04-05', status: 'completed' },
  'cologne-2025': { date: '2025-04-10', end_date: '2025-04-13', status: 'completed' },
  'warsaw-2025': { date: '2025-04-12', end_date: '2025-04-13', status: 'completed' },
  'sharjah-2025': { date: '2025-04-12', end_date: '2025-04-12', status: 'completed' },
  'taipei-2025': { date: '2025-04-12', end_date: '2025-04-12', status: 'completed' },
  'paris-2025': { date: '2025-04-18', end_date: '2025-04-20', status: 'completed' },
  'miami-beach-2025': { date: '2025-04-19', end_date: '2025-04-19', status: 'completed' },
  'barcelona-2025': { date: '2025-04-25', end_date: '2025-04-27', status: 'completed' },
  'heerenveen-2025': { date: '2025-05-09', end_date: '2025-05-11', status: 'completed' },
  'berlin-2025': { date: '2025-05-16', end_date: '2025-05-18', status: 'completed' },
  'incheon-2025': { date: '2025-05-17', end_date: '2025-05-17', status: 'completed' },
  'bangkok-2025': { date: '2025-05-24', end_date: '2025-05-25', status: 'completed' },
  'cardiff-2025': { date: '2025-05-30', end_date: '2025-06-01', status: 'completed' },
  ...
  'sydney-2025': { date: '2025-07-04', end_date: '2025-07-06', status: 'completed' },
  'abu-dhabi-2025': { date: '2025-07-19', end_date: '2025-07-19', status: 'completed' },
  'delhi-2025': { date: '2025-07-19', end_date: '2025-07-19', status: 'completed' },
  'yokohama-2025': { date: '2025-08-09', end_date: '2025-08-09', status: 'completed' },
  'beijing-2025': { date: '2025-08-23', end_date: '2025-08-23', status: 'completed' },
  'perth-2025': { date: '2025-09-05', end_date: '2025-09-07', status: 'completed' },
  'mumbai-2025': { date: '2025-09-07', end_date: '2025-09-07', status: 'completed' },
  'maastricht-2025': { date: '2025-09-19', end_date: '2025-09-21', status: 'completed' },
  'sao-paulo-2025': { date: '2025-09-19', end_date: '2025-09-21', status: 'completed' },
  'oslo-2025': { date: '2025-09-26', end_date: '2025-09-28', status: 'completed' },
  'rome-2025': { date: '2025-09-26', end_date: '2025-09-28', status: 'completed' },
  'hamburg-2025': { date: '2025-10-02', end_date: '2025-10-05', status: 'completed' },
  'toronto-2025': { date: '2025-10-03', end_date: '2025-10-05', status: 'completed' },
  'geneva-2025': { date: '2025-10-11', end_date: '2025-10-12', status: 'completed' },
  'gdansk-2025': { date: '2025-10-11', end_date: '2025-10-12', status: 'completed' },
  'valencia-2025': { date: '2025-10-17', end_date: '2025-10-19', status: 'completed' },
  'birmingham-2025': { date: '2025-10-22', end_date: '2025-10-26', status: 'completed' },
  'atlanta-2025': { date: '2025-10-31', end_date: '2025-11-02', status: 'completed' },
  'stuttgart-2025': { date: '2025-10-31', end_date: '2025-11-02', status: 'completed' },
  'mexico-city-2025': { date: '2025-11-07', end_date: '2025-11-09', status: 'completed' },
  'dublin-2025': { date: '2025-11-12', end_date: '2025-11-16', status: 'completed' },
  'chicago-2025': { date: '2025-11-14', end_date: '2025-11-16', status: 'completed' },
  'bordeaux-2025': { date: '2025-11-20', end_date: '2025-11-23', status: 'completed' },
  'madrid-2025': { date: '2025-11-27', end_date: '2025-11-30', status: 'completed' },
  'utrecht-2025': { date: '2025-11-28', end_date: '2025-11-30', status: 'completed' },
  'singapore-2025': { date: '2025-11-29', end_date: '2025-11-30', status: 'completed' },
  'johannesburg-i-2025': { date: '2025-11-29', end_date: '2025-11-30', status: 'completed' },
  'rio-de-janeiro-2025': { date: '2025-11-29', end_date: '2025-11-29', status: 'completed' },
  'london-excel-2025': { date: '2025-12-04', end_date: '2025-12-07', status: 'completed' },
  'verona-2025': { date: '2025-12-05', end_date: '2025-12-07', status: 'completed' },
  'melbourne-2025': { date: '2025-12-11', end_date: '2025-12-14', status: 'completed' },
  'gent-2025': { date: '2025-12-12', end_date: '2025-12-14', status: 'completed' },
  'stockholm-2025': { date: '2025-12-18', end_date: '2025-12-21', status: 'completed' },
  ...
  'barcelona-2026': { date: '2026-05-14', end_date: '2026-05-17', status: 'completed' },
  ...
  'helsinki-2026': { date: '2026-05-09', end_date: '2026-05-10', status: 'completed' },
  'hong-kong-2026': { date: '2026-05-08', end_date: '2026-05-10', status: 'completed' },
  'cardiff-2026': { date: '2026-04-29', end_date: '2026-05-04', status: 'completed' },
  'lisboa-2026': { date: '2026-05-01', end_date: '2026-05-03', status: 'completed' },
  'paris-gp-2026': { date: '2026-04-23', end_date: '2026-04-27', status: 'completed' },
  'sao-paulo-2026': { date: '2026-04-25', end_date: '2026-04-25', status: 'completed' },
